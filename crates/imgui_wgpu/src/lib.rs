/// Copy-paste from https://github.com/Yatekii/imgui-wgpu-rs
/// Not using the crate version, because wgpu updates are followed with a large delay
use imgui::{
...
impl Renderer {
    ...
    pub fn prepare(
        ...
        let mut render_data = render_data.unwrap_or_else(|| RenderData {
            ...
            index_buffer: None,
            index_buffer_size: 0,
            draw_list_offsets: Vec::with_capacity(4),
            render: false,
        });
